...
subtitle: Industrial automation, humanoid robots, autonomous mobility, and the physical AI revolution.
category: Sector
permalink: /sectors/robotics/
---
...
|---|---|---|---|
| Industrial Robot Arm | Mass production | Ongoing | <span class="conf-badge conf-confirmed">Confirmed</span> |
| Collaborative Robot (Cobot) | Mass production | Ongoing | <span class="conf-badge conf-confirmed">Confirmed</span> |
| Robot-Assisted Surgery | Mass production | Ongoing | <span class="conf-badge conf-confirmed">Confirmed</span> |
| 2D Machine Vision | Mass production | Ongoing | <span class="conf-badge conf-confirmed">Confirmed</span> |
| Full Warehouse Automation | Early commercial | 2027 | <span class="conf-badge conf-confident">Confident</span> |
| Humanoid Robot (Factory Deployment) | Pilot | 2026 | <span class="conf-badge conf-confident">Confident</span> |
| ADAS Level 2 (Partial Automation) | Mass production | Ongoing | <span class="conf-badge conf-confirmed">Confirmed</span> |
| Autonomous Trucking (Highway) | Pilot | 2025 | <span class="conf-badge conf-confident">Confident</span> |
| Full Self-Driving Level 4 (Urban) | Pilot | 2028 | <span class="conf-badge conf-confident">Confident</span> |
...
<div class="accordion-item">
  <button class="accordion-toggle" onclick="toggleAcc(this)">
    Industrial Automation (Established) <span class="acc-arrow">&#9660;</span>
  </button>
