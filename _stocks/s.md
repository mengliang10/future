...
<div class="roadmap-stock-item-impact">&#128200; SentinelOne's on-device AI model detects threats in real time without cloud round-trips. Behavioural AI detection is the industry standard shift away from signature-based AV.</div>
</div>

<div class="roadmap-stock-item">
<div class="roadmap-stock-item-header">
<span class="roadmap-stock-item-name">AI-Autonomous Security Operations Centre</span>
...
<div class="roadmap-stock-item">
<div class="roadmap-stock-item-header">
<span class="roadmap-stock-item-name">XDR (Extended Detection & Response)</span>
<span class="conf-badge conf-confident">Confident</span>
<span class="roadmap-stock-item-year">2026</span>
</div>
<div class="roadmap-stock-item-impact">&#128200; SentinelOne's Singularity XDR extends beyond endpoint to cloud, identity, and network. XDR consolidation is the platform play competing with CrowdStrike Falcon and Palo Alto XSIAM.</div>
</div>
